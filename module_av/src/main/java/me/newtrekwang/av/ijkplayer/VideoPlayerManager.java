package me.newtrekwang.av.ijkplayer;
...
import me.newtrekwang.av.ijkplayer.media.IRenderView;
...
public class VideoPlayerManager {
    ...
    public VideoPlayerManager(final Activity activity, IjkVideoView videoView) {
        try {
...
//            $.id(R.id.app_video_loading).visible();
    ...
    public VideoPlayerManager playInFullScreen(boolean fullScreen) {
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        return this;
    ...
    public VideoPlayerManager onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public VideoPlayerManager onComplete(OnCompleteListener onCompleteListener) {
        this.onCompleteListener = onCompleteListener;
        return this;
    }

    public VideoPlayerManager onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public VideoPlayerManager onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener) {
     ...
     * @return
     */
    public VideoPlayerManager live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }
